...
public class DownloadCore {
    ...
    public static void download(boolean doubleCheck, String url, Map<String, String> requestHeaders,  int timeout, int readTimeout, int maxErrorCount, DownloadCallback cb, ChunkCallback optionalCCB, CheckSignal chk, boolean async) {
        if (doubleCheck) {
            Runnable dlVar = () -> {
                int errorCount = 0;
